...
public class Cajero implements IMetodos{
	...
	//Esta es la clase que implementara la logica
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		//Entonces asignamos si exite la cuenta en el HashMap
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		//Si se encuntra o se localiza la cuenta, la asignamos
		//para manipularla
		if (consultar(numeroCuenta) !=null) {
			...
			if(monto>9000) {//Validamos si el monto excede el maximo retiro en cajero
			...
			return ticket;
		}else if (cuenta.getSaldo()-monto<cuenta.getSaldoMin()) {//Si el saldo menos el monto a retirar es menor que el saldoMin que se debe tener
			//en la cuenta
			System.out.println("El retiro dejaria por debajo del min a la cuenta");
			return ticket;
