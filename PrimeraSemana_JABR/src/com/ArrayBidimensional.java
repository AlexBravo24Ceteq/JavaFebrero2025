...
public class ArrayBidimensional {
	...
	public static void main(String[] args) {
		...
		// Arraybidimensional. Pasa de ser un concepto de una fila
		//a tener más elementos en una "tabla"
		//Permitiendónos tener una capacidad mayor de almacenar elementos
		//Los arrays de dos dimensiones son conocidos también como
		//"matrices"
		...
		//Como almacenamos valores en cada posición de nuestro array bidimensional
		...
		//¿Cómo puedo tener un array que me permita almacenar tipos de dato int, String,
